...
музыкант, блогер, программист, Linux юзер

# биография

Зовут Вася, фамилию зачем вам знать? Да и наверное некоторые вещи
тоже.  
Страна/регион: Беларусь, Минская область  
Любимые ОС: Windows 11, ядро Linux  
Телефон: iPhone SE (Gen. 2) iOS 18 Наверное стану программистом,
блогером и композитором  
Языки программирования которые учу/буду учить/наверное хочу выучить:
Python, C++ и много чего(Хотя зная себя я возможно выучу)

# хаб для соцсетей сайванчика

Telegram: <https://t.me/saivan4ick>  
ТТ: <https://www.tiktok.com/@sai.vann>  
Discord Сервер:
